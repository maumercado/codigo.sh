...
<div class="container">
  ...
  <p>
    I've been a software engineer for almost 9+ years now. I started with
    Python and Python/Django, then Ruby and Ruby on Rails, and lastly, Javascript, focusing mostly on the server-side with NodeJS.
